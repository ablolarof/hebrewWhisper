...
| # | Task | Notes |
|---|---|---|
| 3.1 | ~~Kaggle version of `Whisper_Audio.ipynb`~~ | **Done and verified 2026-08-01** as `Kaggle/hebrew-transcription.ipynb`. Built out of phase order because the user wants to share this with people who should not need a Hugging Face account — which a `NUM_SPEAKERS = 1` setting cannot deliver. Confirmed running on Kaggle. |
